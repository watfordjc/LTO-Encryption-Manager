...
namespace uk.JohnCook.dotnet.LTOEncryptionManager.Utils
{
    public static partial class Encodings
	{
        ...
        public static bool TryGetToBase58CheckEncoded(ReadOnlySpan<byte> versionBytes, ReadOnlySpan<byte> data, [NotNullWhen(true)] out byte[]? versionedData)
        {
        ...
        private static byte[] GetBase58CheckChecksum(byte[] data)
        {
        ...
        public static bool VerifyBase58CheckChecksum(ReadOnlySpan<byte> versionedData)
        {
            ...
            ReadOnlySpan<byte> calculatedChecksum = GetBase58CheckChecksum([.. data]);
